...
- `brand_information`: (`Record<`[Cabin Code](/glossary#cabin-code)`,` `Record<string,`[Brand Information](/glossary#flight-brand-information)`>` `>`) An object containing information about the brands available for each cabin.
