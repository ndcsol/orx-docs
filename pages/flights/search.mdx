...
To search for flights, you can use the POST /flight/search endpoint. This endpoint requires a specific payload that includes information about the flight search.
...
This payload includes the following fields:
...
- `preferences`: An object that represents additional search preferences. The example above includes preferred providers, PCCs, and a discount code. See advanced use for more info.
