...
Clients can retrieve information about a session by using the `/session/[sessionId]` endpoint. This will return the session object described above, providing the client with important details about their search.
