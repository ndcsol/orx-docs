...
By this point, all [Passenger](/versions/v5/glossary#passenger-information) need to have a complete `personal_info` object. At least one adult passenger needs to have their `email` and `phone_number` set.
...
- `public`: ([Public ID](/versions/v5/glossary#public-id)) The public ID of the pricing.
...
- `itinerary_price`: ([Pricing Itinerary Price Information](/versions/v5/glossary#pricing-itinerary-price-information)) An object containing all the information about the pricing of the session.
...
- `commission`: ([Commission Details](/versions/v5/glossary#commission-details)`?`) An object containing the commission details for the priced itinerary. 
