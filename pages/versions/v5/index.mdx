...
ORX API v5 introduces hotel booking capabilities alongside the existing flight booking system, with no breaking changes to existing integrations:

**[Hotel Booking](/versions/v5/hotels)**: Full hotel search, booking, and cancellation system
...
```shell copy
curl -H "x-api-version: 5" https://api.orx.travel/example
```
