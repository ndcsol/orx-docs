...
🔗 [Loading the SDK](/versions/v5/sdk#loading-the-sdk)
...
🔗 [Create Order Possible Errors](/versions/v5/flights/order#possible-errors)
...
🔗 [Pricing Response](/versions/v5/flights/pricing#response)
...
🔗 [Payment Authorization](/versions/v5/glossary#payment-authorization)
...
🔗 [Risk Evaluation](/versions/v5/glossary#risk-evaluation)
