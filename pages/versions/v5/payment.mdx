...
> 🧨 The endpoint requires a payment object, including a TokenEx token which has been tokenized [CVV/CVC attached to it](/versions/vv5payment/initiate).
...
The payload needs to be of type [payment information](/versions/v5/glossary#payment-information).
...
The updated properties will be reflected in the response of type [payment information](/versions/v5/glossary#payment-information).
...
The response will be an array of [payment information](/versions/v5/glossary#payment-information) objects.
...
The response will be a [payment information](/versions/v5/glossary#payment-information) object.
...
Use this endpoint to create a payment for a specific session. Since having multiple forms of payment is not yet supported, you could use the [update payment](/versions/v5/payment/management#update-payment) endpoint to create and update a singular payment.
...
The response will contain the created payment [payment information](/versions/v5/glossary#payment-information).
...
The payload needs to be of type [alternative payment information](/versions/v5/glossary#alternative-payment-information).
...
The updated properties will be reflected in the response of type [alternative payment information](/versions/v5/glossary#alternative-payment-information).
...
The response will be an array of [alternative payment information](/versions/v5/glossary#alternative-payment-information) objects.
...
The response will be a [alternative payment information](/versions/v5/glossary#alternative-payment-information) object.
...
Use this endpoint to create an alternative payment for a specific session. Since having multiple payment/alternative payment is not yet supported, you could use the [update alternative payment](/versions/v5/payment#update-alternative-payment) endpoint to create and update a singular payment.
...
The response will contain the created alternative payment [alternative payment information](/versions/v5/glossary#alternative-payment-information).
