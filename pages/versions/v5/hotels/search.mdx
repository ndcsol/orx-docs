...
| 404 | Invalid Key Exception | API key exists but is invalid or inactive | ORX_INVALID_API_KEY      |
...
| 404 | Session Not Found | Session lookup failed during creation process | ORX_SESSION_NOT_FOUND    |
| 500 | Internal Error Exception | Unhandled server errors, MongoDB issues, or unexpected errors | ORX_UNKNOWN_ERROR        |
