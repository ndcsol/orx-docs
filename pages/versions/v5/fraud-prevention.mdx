...
The following content assumes that the [Browser SDK](/versions/v5/sdk) is configured and loaded. 
...
If 3D Secure is presented, the response object will be of type [3D Secure Action](/versions/v5/glossary#3d-secure-action).
...
Upon success, the response object will be of type [3d secure success](/versions/v5/glossary#3d-secure-success).
...
The response object will be of type [3d secure failure](/versions/v5/glossary#3d-secure-failure).
