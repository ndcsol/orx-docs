...
`PUT /versions/v5/passenger/[session_id]`
...
`GET /versions/v5/passenger/[session_id]/[passenger_public]`
...
The response, if complete, will of type [Passenger Information](/versions/v5/glossary#passenger-information).
...
`PUT /versions/v5/passenger/[session_id]/[passenger_public]`
...
The payload needs to be of type [Passenger Information](/versions/v5/glossary#passenger-information).
