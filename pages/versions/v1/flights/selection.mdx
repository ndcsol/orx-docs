...
| -------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| 1. Query bound 1.                                                                                        | 1. Query bound 1. Query bound 2. _Since no selection has been made, all options will be present in both queries._ |
...
| 3. Query bound 2. _ORX will return **only** the options that are compatible with the bound 1 selection._ | 3. Select fares and brands for bound 1.                                                                           |
