...
The response will contain the an array of [selected seat-like](/versions/v1/glossary#selected-seat-like)s selected.
...
The response will contain the an array of [selected seat-like](/versions/v1/glossary#selected-seat-like)s.
