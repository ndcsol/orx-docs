...
You may provide a new payment method here, or create one using the [update payment](/versions/v1/payment#update-payment) endpoint. If you choose to use the payment endpoints, you do not need to provide the payment information in this request.
