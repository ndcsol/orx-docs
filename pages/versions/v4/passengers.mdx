...
`PUT /versions/v4/passenger/[session_id]`
...
`GET /versions/v4/passenger/[session_id]/[passenger_public]`
...
The response, if complete, will of type [Passenger Information](/versions/v4/glossary#passenger-information).
...
`PUT /versions/v4/passenger/[session_id]/[passenger_public]`
...
The payload needs to be of type [Passenger Information](/versions/v4/glossary#passenger-information).
