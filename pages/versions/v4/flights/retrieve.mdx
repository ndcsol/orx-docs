...
- `provider`: (`string?`) Filter the results by the provider of the order.
- `status`: (`QUEUED` | `ISSUED` | `CANCELLED` `?`) Filter the results by the status of the order.
...
You can request a list of all flight orders that you have made. This endpoint will give you a shortened version of the each order. If you wish to retrieve all of the details about each of the order, you can use the [Retrieve Order](#requesting-order-retrieve) endpoint. 

### Response

```json filename="GET /flight/list" copy
[
    {
        "session": {
            "flow": "FLIGHT_BOOKING",
            "expireAt": "2024-12-17T00:00:00.001Z",
            "createdAt": "2024-09-18T14:48:16.443Z",
                ...
                "tax": [
                    {
                        "amount": "14.88",
                        "code": [],
                        "description": "Harmonized Sales Tax Hst Inclu",
                        "_id": "66eae8303f740bf077735203"
                    },
                    {
                        "amount": "35.00",
                        "code": [],
                        "description": "Airport Improvement Fee  Aif",
                        "_id": "66eae8303f740bf077735204"
                    },
                    {
                        "amount": "9.46",
                        "code": [],
                        "description": "Air Travellers Security Charge",
                        "_id": "66eae8303f740bf077735205"
                    }
                ]
            },
            "surcharge": {
        ...
        "itinerary": [
            {
                ...
                "sort_field": {
                    "provider": "SABRE",
                    "departure_date_time": "2024-12-10 10:15:00",
                    "arrival_date_time": "2024-12-10 12:34:00",
                    "airline": [
                        "Porter Airlines"
                    ],
                    "stops": 0,
                    "elapse_time": "5.19",
                    "cheapest_price": "129.34",
                    "alliances": [],
                    "emission": 332.87,
                    "onlyExcluded": false
                },
                "segments": [
                    {
                        ...
                        "additional_information": {
                            "equipment": {
                                ...
                                "graphic": "https://bnwassets.s3.amazonaws.com/images/aircrafts/PD/295.png"
                            },
                            "e_ticket": "true",
                            "mileage": "2085",
                            "flight_detail": {
                ...
                "brand_information": {},
                "createdAt": "2024-09-18T14:46:55.013Z",
                "public": "b3b6d5eb-0fe1-40be-82ef-bfcfbca201b1",
                "expireAt": "2024-12-17T00:00:00.001Z",
                "check_in": {
                    "check_in_link": "https://www.flyporter.com/en-ca/manage-flights/web-check-in",
                    "check_in_window": [
                        "2024-12-09 09:15:00",
                        "2024-12-10 08:45:00"
                    ]
        ...
        "createdAt": "2024-09-18T14:48:16.627Z",
...
- `itinerary_price`: ([Itinerary Price Information](/versions/v4/glossary#itinerary-price-information)) An object containing all the information about the pricing of the order.
- `itinerary`: (`Array<`[Order Flight Fare](/versions/v4/glossary#order-flight-fare)`>`) An array containing the details of each bound's Order Flight Fare.
- `session`: ([Session](/versions/v4/glossary#session)) Information about the long-lived booking session.  
...
- `booking_references`: (`Array<Record>`) An array containing booking reference information. There may or may not be one locator per marketing airline in the booking, depending on the type of the partnership.
  - `booking_references[].airline`: ([Airline IATA Code](/versions/v4/glossary#airline-iata-code)) The IATA code of the airline.
  - `booking_references[].locator`: (`string`) The unique identifier for the booking reference provided by the airline.
- `itinerary_price`: ([Itinerary Price Information](/versions/v4/glossary#itinerary-price-information)) An object containing all the information about the pricing of the order.
- `itinerary`: (`Array<`[Order Flight Fare](/versions/v4/glossary#order-flight-fare)`>`) An array containing the details of each bound's Order Flight Fare.
- `passengers`: (`Array<`[Flight Order Passenger Information](/versions/v4/glossary#flight-order-passenger-information).`>`) An array containing the details of all passengers.
- `seats`: (`Array<`[Order Seat-Like](/versions/v4/glossary#order-seat-like)`>`) An array of all the seats within the order.
- `riskEvaluation`: ([Risk Evaluation](/versions/v4/glossary#risk-evaluation)`?`) An object containing the risk evaluation of the order.
- `paymentAuthorization`: ([Payment Authorization](/versions/v4/glossary#payment-authorization)`?`) An object containing the payment authorization of the order.
