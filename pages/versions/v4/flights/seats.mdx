...
- `origin`: ([Airport IATA Code](/versions/v4/glossary#airport-iata-code)) The IATA code of the origin airport of the segment the seat map belongs to.
- `destination`: ([Airport IATA Code](/versions/v4/glossary#airport-iata-code)) The IATA code of the destination airport of the segment the seat map belongs to.
...
- `seat_map`: (`Array<`[Seat Row](/versions/v4/glossary#seat-row)`>` `?`) The seat map for the segment. Consisting of an array of rows.
...
- Passenger [Public ID](/versions/v4/glossary#public-id) must've been requested from the [retrieving all passengers](/versions/v4/passengers#retrieving-all-passengers) endpoint.

- The [seat-like](/versions/v4/glossary#seat-like) being selected must have the `selectable` property set to `true`.
...
The response will contain the [selected seat-like](/versions/v4/glossary#selected-seat-like) that was selected.

- ([Selected seat-like](/versions/v4/glossary#selected-seat-like)): The seat-like that was selected containing minimal information about the passenger.
...
The response will contain the an array of [Selected Seat-Likes](/versions/v4/glossary#selected-seat-like) selected.

- (`Array<`[Selected seat-like](/versions/v4/glossary#selected-seat-like)`>`): The seat-likes selected containing minimal information about the passenger.
...
The response will contain the [selected seat-like](/versions/v4/glossary#selected-seat-like) selected.

- ([Selected seat-like](/versions/v4/glossary#selected-seat-like)): The seat-like selected.
...
The response will contain the an array of [Selected seat-Likes](/versions/v4/glossary#selected-seat-like).

- (`Array<`[Selected seat-like](/versions/v4/glossary#selected-seat-like)`>`): The seat-likes selected.
