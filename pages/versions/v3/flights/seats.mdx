...
- `origin`: ([Airport IATA Code](/versions/v3/glossary#airport-iata-code)) The IATA code of the origin airport of the segment the seat map belongs to.
- `destination`: ([Airport IATA Code](/versions/v3/glossary#airport-iata-code)) The IATA code of the destination airport of the segment the seat map belongs to.
...
- `seat_map`: (`Array<`[Seat Row](/versions/v3/glossary#seat-row)`>` `?`) The seat map for the segment. Consisting of an array of rows.
...
- Passenger [Public ID](/versions/v3/glossary#public-id) must've been requested from the [retrieving all passengers](/versions/v3/passengers#retrieving-all-passengers) endpoint.

- The [seat-like](/versions/v3/glossary#seat-like) being selected must have the `selectable` property set to `true`.
...
The response will contain the [selected seat-like](/versions/v3/glossary#selected-seat-like) that was selected.

- ([Selected seat-like](/versions/v3/glossary#selected-seat-like)): The seat-like that was selected containing minimal information about the passenger.
...
| 400         | One or more seats are not available              | The selected seat is not selectable.                                                                 | [ORX_SEAT_NOT_FOUND](/versions/v3/errors#orx-errors)       |
| 400         | One or more passengers are not available         | The given passenger does not exist.                                                                  | [ORX_PASSENGER_NOT_FOUND](/versions/v3/errors#orx-errors)  |
| 400         | The seat is already selected by the passenger    | The request is attempting to assign an already-assigned seat to another passenger.                   | [ORX_DUPLICATE_SEAT](/versions/v3/errors#orx-errors)       |
| 400         | There are duplicate seats for the same passenger | The request is attempting to select multiple seats for the same passenger for the exact same flight. | [ORX_DUPLICATE_SEAT](/versions/v3/errors#orx-errors)       |
| 404         | Seat not found or expired                        | The request is attempt to select non-existent seat.                                                  | [ORX_SEAT_NOT_FOUND](/versions/v3/errors#orx-errors)       |
| 404         | Passenger not found or expired                   | The request is attempt to select a non-existent seat.                                                | [ORX_PASSENGER_NOT_FOUND](/versions/v3/errors#orx-errors)  |
...
The response will contain the an array of [Selected Seat-Likes](/versions/v3/glossary#selected-seat-like) selected.

- (`Array<`[Selected seat-like](/versions/v3/glossary#selected-seat-like)`>`): The seat-likes selected containing minimal information about the passenger.

### Possible Errors

| Status Code | Error                                            | Reason                                                                                             | Reason Code                                                |
| ----------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| 400         | One or more seats are duplicated                 | Multiple passengers are being assigned to the same seat, within the same request.                  | [ORX_DUPLICATE_SEAT](/versions/v3/errors#orx-errors)       |
| 404         | Session not found or expired                     | Request targeting a non-existent session.                                                          | [ORX_SESSION_NOT_FOUND](/versions/v3/errors#orx-errors)    |
| 400         | [Validation Error]                               | Failed Validation                                                                                  | [ORX_VALIDATION_EXCEPTION](/versions/v3/errors#orx-errors) |
| 400         | One or more seats are not available              | One or more of the selected seats are not selectable.                                              | [ORX_SEAT_NOT_FOUND](/versions/v3/errors#orx-errors)       |
| 400         | One or more passengers are not available         | One or more of the given passenger IDs are incorrect.                                              | [ORX_PASSENGER_NOT_FOUND](/versions/v3/errors#orx-errors)  |
| 400         | The seat is already selected by the passenger    | The request is attempting to assign an already-assigned seat to another passenger.                 | [ORX_DUPLICATE_SEAT](/versions/v3/errors#orx-errors)       |
| 400         | There are duplicate seats for the same passenger | The request is attempting to select multiple seats for the same passenger for the exact same fare. | [ORX_DUPLICATE_SEAT](/versions/v3/errors#orx-errors)       |
...
The response will contain the [selected seat-like](/versions/v3/glossary#selected-seat-like) selected.

- ([Selected seat-like](/versions/v3/glossary#selected-seat-like)): The seat-like selected.
...
The response will contain the an array of [Selected seat-Likes](/versions/v3/glossary#selected-seat-like).

- (`Array<`[Selected seat-like](/versions/v3/glossary#selected-seat-like)`>`): The seat-likes selected.
