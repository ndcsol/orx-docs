...
- `passengers`: An array of objects that representing each passenger. The example above includes one adult passenger.
  ...
  - `code` is of type [Passenger Code](/versions/v3/glossary#passenger-code).
...
| 500         | NDCx Internal Error     | Unknown                                                             | [NDC_UNKNOWN_ERROR](/versions/v3/errors#orx-errors)                 |
