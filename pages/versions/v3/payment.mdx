...
| 409 | An alternative payment is already attached to session. Multiple payments are not supported. | There is an existing alternative payment attached to the session. You may only attach a `payment` or an `alternativePayment` to a session. |
...
| 404 | Session not found or expired | Request targeting a non-existent session. |
| 409 | An alternative payment is already attached to session. Multiple payments are not supported. | There is an existing alternative payment attached to the session. You may only attach a `payment` or an `alternativePayment` to a session. |
| 409 | A payment is already attached to session. Multiple payments are not supported. | There is an existing payment attached to the session. |
