...
| 500         | NDCx Internal Error | Unknown                                        | [NDC_UNKNOWN_ERROR](/versions/v3/errors#ndc-errors)        |
| 400         | Unauthorized origin | The requested origin has not been whitelisted. | [ORX_UNAUTHORIZED_ORIGIN](/versions/v3/errors#orx-errors)  |
...
> 🧨 The endpoint requires a payment object, including a TokenEx token which has been tokenized [CVV/CVC attached to it](/versions/vv3payment/initiate).
...
The payload needs to be of type [payment information](/versions/v3/glossary#payment-information).
...
The updated properties will be reflected in the response of type [payment information](/versions/v3/glossary#payment-information).
...
| ----------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------- |
| 400         | [Validation Error]                                                                          | Failed Validation                                                                                                                          | [ORX_VALIDATION_EXCEPTION](/versions/v3/errors#orx-errors) |
| 404         | Session not found or expired                                                                | Request targeting a non-existent session.                                                                                                  | [ORX_PASSENGER_NOT_FOUND](/versions/v3/errors#orx-errors)  |
| 409         | An alternative payment is already attached to session. Multiple payments are not supported. | There is an existing alternative payment attached to the session. You may only attach a `payment` or an `alternativePayment` to a session. | [ORX_NO_PAYMENT_ATTACHED](/versions/v3/errors#orx-errors)  |
...
The response will be an array of [payment information](/versions/v3/glossary#payment-information) objects.

### Possible Errors

| Status Code | Error                                    | Reason                                               | Reason Code                                               |
| ----------- | ---------------------------------------- | ---------------------------------------------------- | --------------------------------------------------------- |
| 404         | Payment information not found or expired | There are no payments attached to the given session. | [ORX_NO_PAYMENT_ATTACHED](/versions/v3/errors#orx-errors) |
...
The response will be a [payment information](/versions/v3/glossary#payment-information) object.

### Possible Errors

| Status Code | Error                                    | Reason                                    | Reason Code                                               |
| ----------- | ---------------------------------------- | ----------------------------------------- | --------------------------------------------------------- |
| 404         | Payment information not found or expired | Payment referenced does not exist.        | [ORX_NO_PAYMENT_ATTACHED](/versions/v3/errors#orx-errors) |
| 404         | Session not found or expired             | Request targeting a non-existent session. | [ORX_SESSION_NOT_FOUND](/versions/v3/errors#orx-errors)   |
...
Use this endpoint to create a payment for a specific session. Since having multiple forms of payment is not yet supported, you could use the [update payment](/versions/v3/payment/management#update-payment) endpoint to create and update a singular payment.
...
The response will contain the created payment [payment information](/versions/v3/glossary#payment-information).
...
| 400         | [Validation Error]                                                                          | Failed Validation                                                                                                                          | [ORX_VALIDATION_EXCEPTION](/versions/v3/errors#orx-errors) |
| 404         | Session not found or expired                                                                | Request targeting a non-existent session.                                                                                                  | [ORX_SESSION_NOT_FOUND](/versions/v3/errors#orx-errors)    |
| 409         | An alternative payment is already attached to session. Multiple payments are not supported. | There is an existing alternative payment attached to the session. You may only attach a `payment` or an `alternativePayment` to a session. | [ORX_MULTIPLE_FOP](/versions/v3/errors#orx-errors)         |
| 409         | A payment is already attached to session. Multiple payments are not supported.              | There is an existing payment attached to the session.                                                                                      | [ORX_MULTIPLE_FOP](/versions/v3/errors#orx-errors)         |
...
| Status Code | Error | Reason                            | Reason Code                                               |
| ----------- | ----- | --------------------------------- | --------------------------------------------------------- |
| 404         |       | Payment referenced was not found. | [ORX_NO_PAYMENT_ATTACHED](/versions/v3/errors#orx-errors) |

# Alternative Payments

You may also pay for orders using alternative payment methods. Currently the only supported alternative payment method is [Verto](https://ver.to/). While all alternative payment methods will use the same set of endpoints, each payment method will have its own payload schema.
...
> 🧨 Each session may have a single regular `payment` or a single `alternativePayment`. If you attempt to provide more using one of the endpoints or using the order endpoint, you will receive an error.
...
The payload needs to be of type [alternative payment information](/versions/v3/glossary#alternative-payment-information).
...
The updated properties will be reflected in the response of type [alternative payment information](/versions/v3/glossary#alternative-payment-information).
...
| 400         | [Validation Error]                                                             | Failed Validation                                                                                                              | [ORX_VALIDATION_EXCEPTION](/versions/v3/errors#orx-errors) |
| 404         | Session not found or expired                                                   | Request targeting a non-existent session.                                                                                      | [ORX_SESSION_NOT_FOUND](/versions/v3/errors#orx-errors)    |
| 404         | Alternative payment information not found                                      | Request contained an `alternativePaymentId` that does not exist                                                                | [ORX_NO_PAYMENT_ATTACHED](/versions/v3/errors#orx-errors)  |
| 409         | A payment is already attached to session. Multiple payments are not supported. | There is an existing payment attached to the session. You may only attach a `payment` or an `alternativePayment` to a session. | [ORX_MULTIPLE_FOP](/versions/v3/errors#orx-errors)         |
...
The response will be an array of [alternative payment information](/versions/v3/glossary#alternative-payment-information) objects.

### Possible Errors

| Status Code | Error                                     | Reason                                                           | Reason Code                                               |
| ----------- | ----------------------------------------- | ---------------------------------------------------------------- | --------------------------------------------------------- |
| 404         | Alternative payment information not found | There are no alternative payments attached to the given session. | [ORX_NO_PAYMENT_ATTACHED](/versions/v3/errors#orx-errors) |
| 404         | Session not found or expired              | Request targeting a non-existent session.                        | [ORX_SESSION_NOT_FOUND](/versions/v3/errors#orx-errors)   |
...
The response will be a [alternative payment information](/versions/v3/glossary#alternative-payment-information) object.

### Possible Errors

| Status Code | Error                                     | Reason                                    | Reason Code                                               |
| ----------- | ----------------------------------------- | ----------------------------------------- | --------------------------------------------------------- |
| 404         | Alternative payment information not found | Payment referenced does not exist.        | [ORX_NO_PAYMENT_ATTACHED](/versions/v3/errors#orx-errors) |
| 404         | Session not found or expired              | Request targeting a non-existent session. | [ORX_PASSENGER_NOT_FOUND](/versions/v3/errors#orx-errors) |
...
Use this endpoint to create an alternative payment for a specific session. Since having multiple payment/alternative payment is not yet supported, you could use the [update alternative payment](/versions/v3/payment#update-alternative-payment) endpoint to create and update a singular payment.
...
The response will contain the created alternative payment [alternative payment information](/versions/v3/glossary#alternative-payment-information).
...
| 400         | [Validation Error]                                                                                      | Failed Validation                                                                                                              | [ORX_VALIDATION_EXCEPTION](/versions/v3/errors#orx-errors) |
| 404         | Session not found or expired                                                                            | Request targeting a non-existent session.                                                                                      | [ORX_SESSION_NOT_FOUND](/versions/v3/errors#orx-errors)    |
| 409         | An alternative payment is already attached to session. Multiple alternative payments are not supported. | There is an existing alternative payment attached to the session.                                                              | [ORX_NO_PAYMENT_ATTACHED](/versions/v3/errors#orx-errors)  |
| 409         | A payment is already attached to session. Multiple payments are not supported.                          | There is an existing payment attached to the session. You may only attach a `payment` or an `alternativePayment` to a session. | [ORX_MULTIPLE_FOP](/versions/v3/errors#orx-errors)         |
...
| Status Code | Error | Reason                                        | Reason Code                                               |
| ----------- | ----- | --------------------------------------------- | --------------------------------------------------------- |
| 404         |       | Alternative payment referenced was not found. | [ORX_NO_PAYMENT_ATTACHED](/versions/v3/errors#orx-errors) |
